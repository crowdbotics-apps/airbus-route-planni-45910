"""
Django settings for airbus_route_planni_45910 project.
...
ROOT_URLCONF = 'airbus_route_planni_45910.urls'
...
WSGI_APPLICATION = 'airbus_route_planni_45910.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "airbus_route_planni_45910 API",
    "DESCRIPTION": "API documentation for airbus_route_planni_45910 App",
    "VERSION": "v1",
}
